...
net = init_random_network([1,20,20,1], active, dactive, loss, dloss, activate_on_final=True,momentum_coef=1/10)

# total number of training data points
n = 100
# batch size
m = 5
input = [np.array([[x]]).transpose() for x in np.linspace(0, np.pi, num=n)]
